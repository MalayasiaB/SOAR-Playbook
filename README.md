...
<img src="./images/filename1.png" height="80%" width="80%" alt="Honeypot Steps"/>
<br />
<br />
...
<img src="./images/filename2.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Second action, utilizes Jira for ticket creation that will aid in incident management: <br/>
<img src="./images/filename3.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="./images/filename4.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="./images/filename5.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="./images/filename6.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="./images/filename7.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
...
<img src="./images/filename8.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
The action below network isolation, is to send a confirmation email. This step will finalize the playbook:  <br/>
<img src="./images/filename9.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Finalized Playbook:  <br/>
<img src="./images/filename10.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Here; I am showcasing events, KPI's before and after assigning a workload to myself:  <br/>
<img src="./images/filename11.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Assigned workload:  <br/>
<img src="./images/filename12.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<br />
<br />
Completed workload and KPI's:  <br/>
<img src="./images/filename13.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
